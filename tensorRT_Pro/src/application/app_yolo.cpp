...
static const char *voclabels[] = {"tank"}; // 修改2 25行新增代码，为自训练模型的类别名称
...
static void test(Yolo::Type type, TRT::Mode mode, const string& model){
    ...
    if(not iLogger::exists(model_file)){
        TRT::compile(
            ...
            int8process,
            "inference",
            "yolov5_trimmed_qat_precision_config_calib.cache"
        );
    }
...
int app_yolo(){
    ...
    test(Yolo::Type::V5, TRT::Mode::INT8, "yolov5_trimmed_qat_noqdq");
